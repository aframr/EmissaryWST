...
module.exports.template.update = function (req, res) {
    Theme.findOne({
        ...
        if (req.body.field1) theme.field1 = req.body.field1;
        if (req.body.field2) theme.field2 = req.body.field2;
        if (req.body.field3) theme.field3 = req.body.field3;
        if (req.body.field4) theme.field4 = req.body.field4;
        if (req.body.field5) theme.field5 = req.body.field5;
