...
var stripe = require('stripe')('sk_test_dqzYJJ6xWGgg6U1hgQr3hNye'); // TODO: do i need to do this for every js file that uses stripe?

_exports.createSubscription = function (req, res) {
...
_exports.getSubscription = function (req, res) {
