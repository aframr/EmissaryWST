...
function updateWithAdminId(req, res) {
  ...
  TemplateForm.findOneAndUpdate({ _admin_id: req.params.adminid }, update, function (err, template) {
    if (err) {
...
module.exports.template.update = function (req, res) {
  ...
  TemplateForm.findOneAndUpdate({ _id: req.body.template_id }, update, options, function (err, template) {
    if (err) {
