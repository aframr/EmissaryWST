 ...
 *   }
 */
_exports.login = function (req, res) {
 ...
 *   }
 */
_exports.getAllEmployees = function (req, res) {
 ...
 *   }
 */
_exports.getById = function (req, res) {
 ...
 *   }
 */
_exports.insert = function (req, res) {
  var employee = new Employee();

  /* required info */
  employee.first_name = req.body.first_name;
  employee.last_name = req.body.last_name;
  employee.email = req.body.email, employee.phone_number = req.body.phone_number, employee.company_id = req.body.company_id, employee.password = employee.generateHash(req.body.password), employee.role = req.body.role;
 ...
 *   }
 */
_exports.update = function (req, res) {
 ...
 *   }
 */
_exports.delete = function (req, res) {
  Employee.findById(req.params.id, function (err, employee) {
