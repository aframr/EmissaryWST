...
describe('Visitor List Socket', function () {
  var currCompany = void 0;
  var currVisitorList = void 0;
  var appointment1 = void 0;
  var appointment2 = void 0;
  var visitor1 = void 0;
  var client1 = void 0;
      ...
      appointment1.save(function (err, a1) {
        ...
        appointment2.save(function (err, a2) {
          ...
          client1.once('connect', function () {
            ...
            client1.on(VISITOR_LIST_UPDATE, updateList = function (_updateList) {
              function updateList(_x) {
                return _updateList.apply(this, arguments);
              }

              updateList.toString = function () {
                return _updateList.toString();
              };
  ...
  it('Should add visitors to List', function (done) {
    ...
    client2.once('connect', function () {
      ...
      client2.on(VISITOR_LIST_UPDATE, function (data) {
        ...
        client1.on(VISITOR_LIST_UPDATE, updateList = function (_updateList2) {
          function updateList(_x2) {
            return _updateList2.apply(this, arguments);
          }

          updateList.toString = function () {
            return _updateList2.toString();
          };
  ...
  it('Should get visitors from list', function (done) {
    ...
    client1.on(VISITOR_LIST_UPDATE, updateList = function (_updateList3) {
      function updateList(_x3) {
        return _updateList3.apply(this, arguments);
      }

      updateList.toString = function () {
        return _updateList3.toString();
      };
  ...
  it('remove visitor from list', function (done) {
    ...
    client1.on(VISITOR_LIST_UPDATE, updateList = function (_updateList4) {
      function updateList(_x4) {
        return _updateList4.apply(this, arguments);
      }

      updateList.toString = function () {
        return _updateList4.toString();
      };
